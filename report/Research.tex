...
\begin{figure}[htbp]
\centering \includegraphics[width=1\linewidth]{/run/user/1000/gvfs/smb-share:server=skynet.local,share=public/nls-research/figures/figure_7_methodology_flowchart}
...
\begin{figure}[htbp]
\centering \includegraphics[width=1\linewidth]{/run/user/1000/gvfs/smb-share:server=skynet.local,share=public/nls-research/figures/figure_4_profile_decomposition}
...
\end{prop}
\begin{figure}[htbp]
\centering \includegraphics[width=1\linewidth]{/run/user/1000/gvfs/smb-share:server=skynet.local,share=public/nls-research/figures/figure_5_concentration_vs_peaks}
...
to $x_{0}$ as $E\to\infty$, illustrating Claim 2. The convergence
rate is $\left|Rz_{i}-x_{0}\right|=O\left(E^{-\frac{1}{2}}\right)$.}
...
\end{defn}
\begin{figure}[htbp]
\centering \includegraphics[width=1\linewidth]{/run/user/1000/gvfs/smb-share:server=skynet.local,share=public/nls-research/figures/figure_6_interaction_decay}
...
\begin{figure}[htbp]
\centering \includegraphics[width=1\linewidth]{/run/user/1000/gvfs/smb-share:server=skynet.local,share=public/nls-research/figures/figure_2_peak_configurations}
\caption{Schematic representations of the admissible multi-peak configurations
classified in Section 3 \ref{sec:classification}.\protect \\
...
equivalent to $\frac{\left|\lambda_{2}\right|}{\left|\lambda_{1}\right|}\protect\geq3$.\textbf{}\protect \\
\textbf{(e)} The perturbation $\delta y^{0}$ (Claim 3) at $R=0$
for $\mu=4$: gray circles show the unperturbed positions $y_{i}$,
colored squares show the perturbed positions $y_{i}+\delta y_{i}^{0}$,
with arrows indicating the displacement. The parameters $\beta=\frac{1}{2}\ln\left(\frac{\alpha_{12}}{\alpha_{23}}\right)$
and $\gamma=\frac{2\beta}{3\sqrt{3}}$ are derived from the requirement
that $\tilde{\alpha}_{12}=\tilde{\alpha}_{13}=1$.}
...
\end{proof}
\begin{figure}[htbp]
\centering \includegraphics[width=1\linewidth]{/run/user/1000/gvfs/smb-share:server=skynet.local,share=public/nls-research/figures/figure_3_alpha_vs_theta_vs_mu}
...
is computed from the expressions derived in Example 3.4 (equations
for $\alpha_{12}$, $\alpha_{13}$, $\alpha_{23}$ as functions of
$\lambda_{1}$, $\lambda_{2}$, and $\theta$). The shaded region
...
\begin{figure}[htbp]
\centering \includegraphics[width=0.75\linewidth]{/run/user/1000/gvfs/smb-share:server=skynet.local,share=public/nls-research/figures/figure_1_admissibility_binding}
