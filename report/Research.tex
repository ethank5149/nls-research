...
\begin{figure}[htbp]
\centering \includegraphics[width=1\linewidth]{../figures/figure_7_methodology_flowchart}
...
\begin{figure}[htbp]
\centering \includegraphics[width=1\linewidth]{../figures/figure_4_profile_decomposition}
...
\end{prop}
\begin{figure}[htbp]
\centering \includegraphics[width=1\linewidth]{../figures/figure_5_concentration_vs_peaks}
...
\end{defn}
\begin{figure}[htbp]
\centering \includegraphics[width=1\linewidth]{../figures/figure_6_interaction_decay}
...
\begin{figure}[htbp]
\centering \includegraphics[width=1\linewidth]{../figures/figure_2_peak_configurations}
...
\end{proof}
\begin{figure}[htbp]
\centering \includegraphics[width=1\linewidth]{../figures/figure_3_alpha_vs_theta_vs_mu}
...
\end{prop}
\begin{table}[htbp]
\centering \caption{Summary of admissible $\theta$-ranges as a function of $\mu=\frac{\left|\lambda_{2}\right|}{\left|\lambda_{1}\right|}$.}
\label{tab:summary} %
\begin{tabular}{cc}
\toprule 
...
\begin{figure}[htbp]
\centering \includegraphics[width=0.75\linewidth]{../figures/figure_1_admissibility_binding}
