...
\textbf{(e)} The perturbation $\delta y^{0}$ (Proposition~\ref{prop:explicit-soln})
at $R=0$ for $\mu=4$: gray circles show the unperturbed positions
$y_{i}$, colored squares show the perturbed positions $y_{i}+\delta y_{i}^{0}$,
